...
import numpy as np
data1 = np.loadtxt('./Q-deep-q/data-atlanta/AR_deep_q_learning.txt')*100
data2 = np.loadtxt('./Q-deep-q/data-atlanta/AR_q_learning.txt')*100
...
plt.title('Biểu đồ dữ liệu acceptation rate cho mạng atlanta')
